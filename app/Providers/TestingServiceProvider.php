...
class TestingServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        TestResponse::macro('assertComponent', function (string $component, bool $props = true) {
            return $this->assertInertia(fn (AssertableInertia $inertia) => $inertia->component($component, $props));
        });
    }
}
